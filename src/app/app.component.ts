...
export class AppComponent {
  ...
  categoryTemplate = {
    ...
    cols: [
      ...
      {name: 'script', text: '脚本', type: 'text', prefix: '/resources/r', width: '100px'},
      {name: 'url', text: 'URL', type: 'text', prefix: '/resources/r', width: '100px'},
    ],
    key: 'id',
  ...
  postTemplate = {
    ...
    cols: [
      ...
      {name: 'create', text: '创建时间', type: 'date', disabled: true},
      {name: 'update', text: '修改时间', type: 'date', disabled: true},
      {name: 'url', text: 'URL', type: 'text', width: '100px', prefix: '/resources/r'},
      ...
      {name: 'script', text: '脚本', type: 'text', width: '100px', prefix: '/resources/r'},
